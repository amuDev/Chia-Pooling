...
from chiablockchain.chia.consensus.coinbase import pool_parent_id
from chiablockchain.chia.full_node.bundle_tools import simple_solution_generator
from chiablockchain.chia.protocols.pool_protocol import SubmitPartial
from chiablockchain.chia.types.blockchain_format.coin import Coin
from chiablockchain.chia.types.blockchain_format.program import Program, INFINITE_COST, SerializedProgram
from chiablockchain.chia.types.coin_record import CoinRecord
from chiablockchain.chia.types.coin_solution import CoinSolution
from chiablockchain.chia.types.spend_bundle import SpendBundle
from chiablockchain.chia.util.bech32m import decode_puzzle_hash
from chiablockchain.chia.consensus.constants import ConsensusConstants
from chiablockchain.chia.util.ints import uint64, uint16, uint32
from chiablockchain.chia.util.default_root import DEFAULT_ROOT_PATH
from chiablockchain.chia.rpc.full_node_rpc_client import FullNodeRpcClient
from chiablockchain.chia.full_node.signage_point import SignagePoint
from chiablockchain.chia.types.end_of_slot_bundle import EndOfSubSlotBundle
from chiablockchain.chia.types.blockchain_format.sized_bytes import bytes32
from chiablockchain.chia.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from chiablockchain.chia.util.lru_cache import LRUCache
from chiablockchain.chia.wallet.puzzles.load_clvm import load_clvm
        ...
        while True:
            try:
                ...
                coin_records: List[CoinRecord] = await self.node_rpc_client.get_coin_records_by_puzzle_hashes(
                    scan_phs, include_spent_coins=False, end_height=peak_height - self.confirmation_security_threshold
                )
